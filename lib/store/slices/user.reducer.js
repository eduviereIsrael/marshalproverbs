                        ...
                        try{
                            ...
                            if(response.data.data.status === "cancelled"){
                                const newSnapshot = {...userSnapshot, sub: {
                                  ...
                                  await updateUserSubscription(newSnapshot.id, "Starter", null)
...
// export const updateUserSub = createAsyncThunk(
//     'user/updatepurchase',
//     async({userId, productId, subId}, {rejectWithValue, dispatch}) => {
//         try{
//             const response = await updateUserSubscription(userId, productId, subId)
//             dispatch(paymentVerified())
//             dispatch(signInAtFirstRender())
//             return response
//         } catch(error){
